package Seminar7.behavioral.pubsub.task;

import Seminar7.behavioral.pubsub.solution.impl.event.Video;
import Seminar7.behavioral.pubsub.task.pubsub.Subscriber;
import Seminar7.behavioral.pubsub.task.pubsub.VideoChannel;
...
public class RunPubSub {
    ...
    private static void run() {
        ...
        Video bandsOfNewYork = new Seminar7.behavioral.pubsub.solution.impl.event.Video(LocalDateTime.of(
